...
extern "C" {
    ...
    pub fn metacall_value_create_array(values: *const *mut c_void, size: usize) -> *mut c_void;
    pub fn metacall_value_create_map(tuples: *const *mut c_void, size: usize) -> *mut c_void;
}
